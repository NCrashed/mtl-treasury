...
class MTLApp extends StatelessWidget {
  const MTLApp({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'MTL treasury',
      theme: ThemeData(
        primarySwatch: MTLColors.primaryColor,
      ),
      home: const BalancePage(title: 'MTL balance page'),
    );
  }
}
